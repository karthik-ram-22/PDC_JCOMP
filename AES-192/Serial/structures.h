 ...
 */
void KeyExpansion(unsigned char inputKey[16], unsigned char expandedKeys[264]) {
	// The first 192 bits are the original key
	for (int i = 0; i < 24; i++) {
	...
	unsigned char tmpCore[6]; // Temp storage for core

	while (bytesGenerated < 264) {
